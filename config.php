<?php
  ...
  $cfg_BTC_amount  = intval((55 / 60) * $cfg_refresh_time);
  $cfg_BTX_amount  = intval((55 / 60) * $cfg_refresh_time);
  $cfg_DASH_amount = intval((55 / 60) * $cfg_refresh_time);
  $cfg_DOGE_amount = intval((10050 / 60) * $cfg_refresh_time);
  $cfg_ETH_amount  = intval((55 / 60) * $cfg_refresh_time);
  $cfg_LTC_amount  = intval((55 / 60) * $cfg_refresh_time);
  $cfg_POT_amount  = intval((55 / 60) * $cfg_refresh_time);
  ...
  $cfg_BCH_api_key  = 'XXXREDACTEDXXXXXXXXX4d533ffd9bfc';
